...
sso = GenericSSO(
    client_id="test", client_secret="secret", redirect_uri="http://localhost:8080/callback", allow_insecure_http=False
)
...
if __name__ == "__main__":
    uvicorn.run(app="sso:app", host="127.0.0.1", port=8000)
